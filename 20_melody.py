...
x, _ = librosa.load(f'audio/{FILE_NAME}.wav', sr=SR)
...
fig.savefig(f'plot/melody/{FILE_NAME}.wave.png')
...
fig.savefig(f'plot/melody/{FILE_NAME}.spectrogram.png')
...
plt.show()
fig.savefig(f'plot/melody/{FILE_NAME}.melody.png')
